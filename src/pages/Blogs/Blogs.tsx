...
const blogs: Blog[] = [
  {
    ...
    image:
      "https://miro.medium.com/v2/resize:fit:1100/format:webp/1*eqqGLkn3XbYpHNGS-F5SxQ.png",
    slug: "react-19-is-here-here-what-you-need-to-know",
  },
  {
    id: 2,
    title: "All the concepts you need to know to learn React Native",
    image:
      "https://miro.medium.com/v2/resize:fit:828/format:webp/0*d0BdjfkM3LxaNgSK.jpg",
